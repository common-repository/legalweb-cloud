...
With this plugin, you can use the legalweb.io cloud service with your Wordpress page. It connects to the legalweb.io web API and fetches your legal texts, terms & conditions and integrations to insert it in your Wordpress Page.
